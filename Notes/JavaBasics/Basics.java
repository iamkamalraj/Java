...
//
//memory management
//if we say char a ='a'; means two bytes of memory is allocated in the back end
//because java follows the UTF(unicode transformation format) which consists of 65536 charater (2pow16)
//
//where as in C 1Byte is allocated because it follows ASCII(American standard code for information interchange) ,
...
//		long c = 12;
//		byte d =c;               //error because we can't put the long value in byte                 
...
//		int x1=5;
//		int x2 = 2;
//		double x3 = x1/x2;          //doesn't matter if we use the double in the storing variable
...
//		Naming convention
//		camelCase => variables, methods => addTwoNumbers
//		PascalCase => class , objects => SchoolCount
